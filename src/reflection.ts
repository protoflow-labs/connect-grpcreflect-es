 ...
 */
const reflectionHandler = (ds: DescriptorSet) =>
  async function* (reqs: AsyncIterable<ServerReflectionRequest>) {
...
const findDescriptorInMessage = (
  ds: DescriptorSet,
  message: DescMessage,
  suffix: string,
): FileDescriptorCase | undefined => {
